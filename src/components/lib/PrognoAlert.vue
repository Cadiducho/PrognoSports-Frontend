<template>
    <div v-if="variant == 'info'" class="flex items-center bg-blue-100 dark:bg-blue-400 text-blue-700 dark:text-white border-blue-500 text-sm font-bold px-4 py-3 mb-4" role="alert">

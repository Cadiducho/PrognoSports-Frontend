        ...
        <div class="column is-two-fifths">
          <div class="card">
            <div class="card-header">
              <div class="card-header-title">Cambio de contraseña</div>
            </div>
            <div class="card-content">
              <div class="content">
                <p class="has-text-justified">
                  Para solicitar un cambio de contraseña, deberás introducir el
                  correo electrónico de tu cuenta, donde recibirás un código de
                  recuperación.
                </p>
                <p class="has-text-justified">
                  Con dicho código podrás establecer una nueva contraseña para
                  tu cuenta.
                </p>
              </div>
              <form>
...
export default class ForgotPassword extends Vue {
  ...
  handleSubmit(e: any) {
    if (!this.showChangePassword) {
      ...
      if (email) {
        UserModule.userChangePassword(email, inputToken, inputPassword).then(
          () => {
            this.$buefy.toast.open({

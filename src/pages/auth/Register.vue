                        ...
                        <form @submit.prevent="handleSubmit()">
                            <div class="field">
                                ...
                                <div class="control has-icons-left has-icons-right">
                                    ...
                                    <input v-model="form.email" type="email" required
                                           class="input" :class="{ 'is-danger': form.submitted && !form.email }" />
                            ...
                            <div class="field">
                                <label class="checkbox">
                                    <input type="checkbox" v-model="form.tos" required>
                            ...
                            <div class="field is-grouped">
                                <div class="control">
                                    <button :disabled="!form.tos || form.isRegistering" class="button is-link">Regístrate</button>
                                </div>
                            </div>
                        </form>
                    </div>
